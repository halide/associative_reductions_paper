...
\caption{Dependency graphs of various multi-valued Halide \emph{update} definitions. Their subgraph decompositions are shown in red. We search for each subgraph in our precomputed table of elementary operators, and then recompose the results.}
\label{fig:subgraphs}
\end{figure}
