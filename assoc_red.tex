...
Note that this transformation requires that the associative operator has an identity. This is not true for all such operators, such as $2xy$, where $x, y \in \mathds{Z}$.
